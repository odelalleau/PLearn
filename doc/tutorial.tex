...
\begin{figure}
  \center{\includegraphics[width=100mm]{class}}
...
\verbatiminput{../examples/NNet.spec}
...
\ref{df}.\begin{figure}
  \center{\includegraphics[width=100mm]{decbound}}
...
\begin{figure}
  \center{\includegraphics[width=100mm]{reg}}
